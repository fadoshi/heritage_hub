...
<head>
    ...
    <link href="{{ asset('niceaboard/vendor/simple-datatables/style.css') }}" rel="stylesheet">
...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        <img src="{{ asset('niceaboard/img/ppl-icon.png') }}" alt="Profile" class="rounded-circle">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse"
                    href="#">
                    <i class="bi bi-file-earmark-post"></i><span> Manage Posts</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
                <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                    <li>
                        <a href="{{route('admin_posts_index')}}">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#tables-nav" data-bs-toggle="collapse" href="#">
                    <i class="bi bi-tags"></i><span>Manage Tags</span><i
                        class="bi bi-chevron-down ms-auto"></i>
                </a>
            ...
            <li class="nav-heading mt-5">Upcoming Features</li>

            <li class="nav-item">
                <a class="nav-link collapsed" href="">
                    <i class="bi bi-person"></i>
                    <span>Members Birthday</span>
                </a>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex justify-content-between align-items-center mb-4">
          ...
          <a href="{{route('invite_view')}}" class="btn btn-success">Invite New Member</a>
          {{-- <nav>
            <ol class="breadcrumb">
  ...
  <a href="#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
    ...
    <script src="{{ asset('niceaboard/vendor/simple-datatables/simple-datatables.js') }}"></script>
    <script src="{{ asset('niceaboard/vendor/tinymce/tinymce.min.js') }}"></script>
